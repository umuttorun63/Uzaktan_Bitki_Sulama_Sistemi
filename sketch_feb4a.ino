...
#define BLYNK_TEMPLATE_ID "TMPL6fuZfReRj"
#define BLYNK_TEMPLATE_NAME "AkıllısulamaSistemi"
#define BLYNK_AUTH_TOKEN "4r_xstxLB4gW_sE-2ZeZmZE5eqq-ARBY"
...
//  Islak eşiği: nemDegeri bu değerden büyük/eşitse sulama DURUR
int ISLAK_ESIK = 800;
/* ========================================================= */
...
void sensorOku() {
  ...
  // 0=Kuru, 1024=Islak olacak şekilde çevirme
